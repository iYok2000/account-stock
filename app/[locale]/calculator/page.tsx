        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            ...
            <div className="card text-center py-4 sm:py-3">
              ...
              <p className={cn("text-lg font-bold tabular-nums mt-1", result.grossMargin >= 50 ? "text-brown-600" : result.grossMargin >= 30 ? "text-brown-500" : "text-red-600")}>
                {result.grossMargin.toFixed(0)}%
              </p>
              <p className={cn("text-xs tabular-nums", result.profitMargin >= 30 ? "text-brown-600" : result.profitMargin >= 15 ? "text-brown-500" : "text-red-600")}>
