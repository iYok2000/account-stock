...
| [03-orders.md](./03-orders.md) | คำสั่งซื้อ | `/orders` | ตาราง, filter, สร้างคำสั่งซื้อ (mock form), RBAC |
...
เมนูอื่น (shops, campaigns, vouchers, fees, tax, funnels, agents, settings) ยังไม่มี spec แยกในโฟลเดอร์นี้ — ถ้ามีหน้า/component ชัดเจนแล้วค่อยเพิ่มไฟล์ใหม่ได้
